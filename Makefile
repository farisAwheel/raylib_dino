...
PROJECTS := raylib_workshop raylib

.PHONY: all clean help $(PROJECTS) 

all: $(PROJECTS)

raylib_workshop: raylib
ifneq (,$(raylib_workshop_config))
	@echo "==== Building raylib_workshop ($(raylib_workshop_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f raylib_workshop.make config=$(raylib_workshop_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f raylib_workshop.make clean
